...
<div class="row">
    <div class="col-md-10 offset-md-1">
        <a href="{{ url('cabang/create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Add</a>
        <br><br />
                ...
                <table id="example3" class="table table-borderless table-striped table-earning">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$cabang->alamat}}</td>
                            <td>
                                <a href="{{ url("cabang/{$cabang->id}/edit") }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-pencil-square-o"></i> Edit
                                </a>
                                <meta name="csrf-token" content="{{ csrf_token() }}">
                                <button onclick="hapus({{$cabang->id}})" class="btn btn-danger btn-sm">
                                    Hapus
                                </button>
                                </form>
                            </td>
